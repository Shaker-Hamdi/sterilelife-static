...
* http://jqueryui.com
* Includes: widget.js, position.js, focusable.js, form-reset-mixin.js, jquery-1-7.js, keycode.js, labels.js, scroll-parent.js, tabbable.js, unique-id.js, widgets/accordion.js, widgets/tabs.js
...
$(document).ready(function() {
    ...
    (function() {
        if ($("section.homeAchievements").length) {
            $("section.homeAchievements li a").magnificPopup({
                type: "image",
    ...
    //homeAchievements using magnificPopup

    (function() {
        if ($("section.uses").length) {
            $("section.uses ul a").magnificPopup({
                type: 'inline',
                preloader: false,
                focus: '#name',
    ...
    (function() {
        if ($("div.toggleMobileNav").length) {
            $("div.toggleMobileNav a").on("click", function(event) {
                event.preventDefault();
                event.stopPropagation();
    ...
    (function() {
        if ($("section.contactForm form").length) {
            var options = {
                rules: {
                    name: { type: 'text', errMsg: 'Please enter your name' },
                    email: { type: 'email', errMsg: 'Please enter a valid email' },
                    company: { type: 'text', errMsg: 'Please enter your company name' },
                    topic: { type: 'text', errMsg: 'Please Choose a topic' }
                }
            };

            $('section.contactForm form').validate(options);

            $("section.contactForm form").submit(function() {
                var error = 0;
                var message = $("section.contactForm form .message").val();
                if (message == '') {
                    error = 1;
                    $("section.contactForm form .message").parent("label").addClass("is-error").append('<span class="hint">Please enter Your Message</span>');
                }
    ...
    //Validate Contact form Using jquery.form.validation.2.0.0.js plugin
